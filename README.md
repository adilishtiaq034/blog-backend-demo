...
This project includes user authentication, authorization, blog post management, comments, pagination, filtering, automated API testing and Dockerized development with MongoDB Atlas.
